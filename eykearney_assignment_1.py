...
mode = input("Do you want to calculate min, max, or avg: ")
count = input("How many values will you input: ")
values = input("Input your values: ")
value_list = []
for i in range(0, int(count)):
    value_list.append(values)
value_list_flt = [float(i) for i in list]
return(mode)
return(value_list_float)
print(mode)
print(count)
print(len(value_list_float))
print(value_list_float)
...
if mode = "min":
    value_list_float.sort()
    print(value_list_float[0])
elif mode = "max":
    value_list_float.sort()
    print(value_list_float[-1])
else:
    print((sum(value_list_float))/(len(value_list_float)))
